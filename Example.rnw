...
% Science name: use math mode to prevent case changes
\newcommand{\scienceName}{$Clupea$ $pallasii$}

% New definitions: Title, year, report number, authors
% Protect lower case words (i.e., species names) in \Addlcwords{}, in "TechReport.sty", and use math mode.
